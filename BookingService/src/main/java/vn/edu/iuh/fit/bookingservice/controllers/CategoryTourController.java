...
public class CategoryTourController {
    ...
    public ResponseEntity<MessageResponse<CategoryTourResponse>> getCategoryTourById(@PathVariable String categoryTourId){
        return SuccessEntityResponse.FoundResponse("Đã tìm thấy", categoryTourService.getCategoryTourById(categoryTourId));
    }

    @PostMapping
    public ResponseEntity<MessageResponse<CategoryTourResponse>> createCategoryTour(@RequestBody @Valid  CategoryTourRequest categoryTourRequest){
        return SuccessEntityResponse.CreateResponse("Tạo Loại tour thành kông", categoryTourService.createCategoryTour(categoryTourRequest));
    }

    @PutMapping("/{categoryTourId}")
    public ResponseEntity<MessageResponse<CategoryTourResponse>> updateCategoryTour( @PathVariable String categoryTourId, @RequestBody @Valid  CategoryTourRequest categoryTourRequest){
        return SuccessEntityResponse.OkResponse("Cập nhật loại tour thành kông", categoryTourService.updateCategoryTour(categoryTourId, categoryTourRequest));
    }
